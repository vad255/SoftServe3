...
export class ChatBox extends React.Component<{}, IGlobalChat> {
    ...
    render() {
        return (
            <div className="BoxWindow">
                <div id="OutputSection" className="BoxOutputSection">
                    <OutputBox messages={this.state.messages} myself={this.state.myself} />
                </div>
                <textarea id="messageInput" className="boxInput" onKeyPress={this.handleInput.bind(this)} />
            </div>
        );
    }
