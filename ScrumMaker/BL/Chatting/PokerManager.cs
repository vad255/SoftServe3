...
namespace BL.Chatting
{
    ...
    {
        public const string ROOM_NAME = "ScrumMakerPokerRoom";
        ...
        public PokerManager(IRepository<ChatRoom> chats, IRepository<Message> msgs, IRepository<User> users, IRepository<Story> story)
        {
            _chats = chats;
            _msgs = msgs;
            _users = users;
